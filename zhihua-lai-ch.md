...
**GE美国通用(英国剑桥)**
*Staff Software Engineer（2018.12至2020.01）*
GIS软件核心团队。Java, C++ 和 Magik 编译器优化。在加入GE第三周到第四周的时候为 Magik 编程语言加入了真正的 \_while 循环。在第6周的时候为 Magik 语言加入了正则表达式: /abc/g. 
...
**润谱无线科技 (英国剑桥)**
*Principal Algorithm Engineer 高级算法工程师（2010至2018.11）*
我是该产品（C＃7，.NET4.7）的主要开发人员之一：https://ranplanwireless.com/products/ 我负责设计、开发和维护核心库（无线电传播引擎）。它是一个500K行的代码库，由Visual Studio C ++2017、Delphi 10.2 Tokyo以及一些内链汇编和一些VBS / JS组成。

* 敏捷开发
* 核心产品开发：润谱无线传播模型（算法）的作者 My overall job purpose was to provide and implement my algorithm research expertise in developing Ranplan Radio Propagation Model (RPM) which is one of Ranplan's key intellectual property.
* 带领无线传播模型小组：用C++重写
...
- STEEM区块链上的工具：[https://steemyy.com](https://steemyy.com/)
- 一些有意思的Chrome 浏览器插件和在线工具：[https://helloacm.com/tools/](https://helloacm.com/tools/)
...
- 在线视频下载利器和API - [https://weibomiaopai.com](https://weibomiaopai.com)

开源
:   我的大部分工具和库都分享在开源github 上。我的github ID是*doctorlai* 我的 NPMJs ID是 justyy。同时我曾经是 Utopian 的审稿人（用STEEM来奖励开源贡献者）

编程语言
:   Magik, C99, C++ 17, C# 7.0, Java 7, Delphi XE10, Javascript (JQuery, NodeJs), Python 2/3, PHP 7.x, HTML5/CSS, R, SQL, BASH, AWK, LATEX, LUA, LOGO, VBScript, x86 Assembly 

数据库
:   MySQL, MS SQL Server, MongoDB, SQLite

操作系统
:   Ubuntu 18.04 (我长期管理多个VPS), Windows 10

工具
:   Eclipse, Visual Studio, Visual Studio Code, Notepad, Nodepad+, PsPAD, Vim, Emacs, Sublime Text, Editplus
...
* 我开发了在波场Shasta/Nile测试网上的发币水龙头(TRX, USDC, USDT, USDD测试币)

----

> <dr.zhihua.lai [AT] gmail.com> • +44 (0)7939518997 • \
> 现住址 - CB3 0XB, Girton, 英国剑桥
